...
public class NewCourseActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_ID = "com.appdevelopers.roomdatabase.EXTRA_ID";
    public static final String EXTRA_COURSE_NAME = "com.appdevelopers.roomdatabase.EXTRA_COURSE_NAME";
    public static final String EXTRA_DESCRIPTION = "com.appdevelopers.roomdatabase.EXTRA_COURSE_DESCRIPTION";
    public static final String EXTRA_DURATION = "com.appdevelopers.roomdatabase.EXTRA_COURSE_DURATION";
